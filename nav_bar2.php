          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                         ...
                         <li><a href="#" class="smoothScroll">Search <span><i class="fa fa-fw fa-search"></i></span></a></li>
                    </ul>
            ...
            {?>
                <li><a href="dashboard.php"><i class="fa fa-user"></i>Your Dashboard</a></li>
            <?php
            }
            else{
            ?>
                <li><a href="signin.php#about"><i class="fa fa-user"></i>Member</a></li>
                <?php
                }
