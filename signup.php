...
?>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="index.php"><img src="asset/images/Citibuilda white-icon.png" alt="citibuilda" style="width:50px;height:50px;"></a>
...
$('#accesspanel').on('submit', function(e) {
 ...
 <!-- Bootstrap core JavaScript -->
  ...
  <script src="asset/js/clean-blog.min.js"></script>
     <script src="asset/js/logochange.js"></script>
