...
<head>
  ...
  <title>City Builda</title>

  <!-- Favicons -->
  <link href="asset/images/favicon-1.png" rel="icon">
...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
    <!--logo start-->
      <a href="index.php"><img src="asset/images/Citibuilda white-icon.png" alt="citibuilda" style="width:30px;height:30px;"></a>
    <!--logo end-->
      <!--logo end-->
      ...
      <section class="wrapper site-min-height">
        ...
        <a href="post.php?id=<?php echo $row['ID']; ?>">
          ...
          <p class="post-meta">Posted by
            ...
            <a href="process.php?id=<?php echo $row['ID']; ?>" type="btn" class="btn" style="border:1px solid grey;height:auto">Approve</a> 
